...
export const ADMIN_PROMOTION_BORROWING_STATUS_ENUM = pgEnum('promotion_borrowing_status', [
    'APPROVED', 
    'REJECTED',
    'PENDING'
]);
...
export const borrowRequests = pgTable("borrow_requests", {
  ...
  status: ADMIN_PROMOTION_BORROWING_STATUS_ENUM("status").default("PENDING").notNull(),
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow(),
})
